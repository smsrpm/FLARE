...
<rect x="10" y="${PRZ_Y + 10}" width="90" height="48" rx="4" fill="#0d1117" stroke="#30363d" stroke-width="1" opacity="0.88"/><text x="55" y="${PRZ_Y + 26}" font-family="IBM Plex Mono,monospace" font-size="14" fill="#8b949e" text-anchor="middle">SIM TIME</text><text x="55" y="${PRZ_Y + 50}" font-family="IBM Plex Mono,monospace" font-size="20" font-weight="600" fill="#e8530a" text-anchor="middle">${t_sim.toFixed(1)} s</text><rect x="10" y="${PRZ_Y + 68}" width="90" height="48" rx="4" fill="#0d1117" stroke="#30363d" stroke-width="1" opacity="0.88"/><text x="55" y="${PRZ_Y + 84}" font-family="IBM Plex Mono,monospace" font-size="14" fill="#8b949e" text-anchor="middle">CORE PWR</text><text x="55" y="${PRZ_Y + 108}" font-family="IBM Plex Mono,monospace" font-size="20" font-weight="600" fill="#3fb950" text-anchor="middle">${core_pwr.toFixed(1)} MW</text>
...
st.iframe(_iframe_src, height=component_height, scrolling=False)
